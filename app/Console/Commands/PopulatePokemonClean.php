...
class PopulatePokemonClean extends Command
{
    ...
    public function handle()
    {
        $pokemon = [
            ...
            [123, 'Grimer', 'poison'],
            [124, 'Muk', 'poison'],
            [125, 'Shellder Shiny', 'water'],
            [126, 'Cloyster Shiny', 'water,ice'],
            [127, 'Rhyhorn Shiny', 'ground,rock'],
            [128, 'Rhydon Shiny', 'ground,rock'],
            [129, 'Chansey Shiny', 'normal'],
            [130, 'Kangaskhan Shiny', 'normal'],
            [131, 'Horsea Shiny', 'water'],
            [132, 'Seadra Shiny', 'water'],
            [133, 'Goldeen Shiny', 'water'],
            [134, 'Seaking Shiny', 'water'],
            [135, 'Staryu Shiny', 'water'],
            [136, 'Starmie Shiny', 'water,psychic'],
            [137, 'Mr Mime Shiny', 'psychic,fairy'],
            [138, 'Scyther Shiny', 'bug,flying'],
            [139, 'Jynx Shiny', 'ice,psychic'],
            [140, 'Electabuzz Shiny', 'electric'],
            [141, 'Magnemite Shiny', 'electric,steel'],
            [142, 'Magneton Shiny', 'electric,steel'],
            [143, 'Weezing Shiny', 'poison'],
        ...
        $this->info("✅ Populated/Updated $count Pokemon");
    }
}
